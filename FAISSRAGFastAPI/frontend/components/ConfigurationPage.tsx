        ...
        <div style={{
            ...
            <div className="relative animate-fadeIn w-full max-w-2xl max-h-[90vh] overflow-y-auto custom-scrollbar" style={{
                ...
                <form onSubmit={handleSubmit} className="space-y-8 font-serif">
                    ...
                    {/* Parent Dashboard */}
                    <section className="bg-[#3d1f0d]/06 border border-[#8b4513]/30 rounded-sm p-4">
                        <h3 className="font-cinzel text-base mb-1 text-[#3d1f0d]">Parent Dashboard</h3>
                        <p className="text-xs italic opacity-70 mb-3">
                            Upload PDF or EPUB story books to shape the tales your child hears.
                            Stories are generated from your uploaded content only.
                        </p>
                        <a
                            href="http://localhost:5173"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-2 px-4 py-2 border border-[#8b4513] text-[#8b4513] font-cinzel text-xs uppercase tracking-widest rounded-sm hover:bg-[#8b4513] hover:text-[#f2e8cf] transition-all"
                        >
